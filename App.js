          ...
          <View style={{ paddingHorizontal: 15, marginTop: 30, flex: 1 }}>
            ...
            >
              ...
              <Text allowFontScaling={false} category="s1">
                Obidents this is your new campaign messenger, mobilize and
                remind other Nigerians to vote Labour party.
              </Text>
            </View>
                      ...
                      <>
                        ...
                        >
                          <Text appearance="alternative" category="s1">
                            ...
                            randomly assigned a contact from the database, you
                            can then send them a campaign message via WhatsApp
                            or SMS.
                          </Text>
                          <Spacer height={10} />
                          <Text style={{ color: "#fff" }} category="s1">
                            ...
                            SMS Gateways, and to remind them to vote Labour
                            Party and Join the Obidents Movement.
                          </Text>
                        </View>
                  ...
                  <>
                    ...
                    >
                      <Text style={{ color: "#fff" }} category="s1">
                        ...
                        phone numbers from your phone to the database, The
                        contact will be randomly assigned to participants of the
                        campaign.
                      </Text>
                      <Spacer height={10} />
                      <Text style={{ color: "#fff" }} category="s1">
